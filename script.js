document.addEventListener("DOMContentLoaded", () => {
    ...
    themeToggleBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            themeToggleBtns.forEach(updateBtn => {
                ...
                if (newTheme === 'dark') { icon.textContent = '☀️'; text.textContent = '日間模式'; } 
                else { icon.textContent = '🌙'; text.textContent = '夜間模式'; }
            });
        });
    });
    ...
    const translations = {
        "zh-TW": {
            ...
            "pf_btn": "查看專案詳情 >",
            "pf_1_title": "網頁開發專案 A", "pf_1_desc": "結合 HTML/CSS 的響應式個人網站設計。",
            "pf_2_title": "多媒體設計專案 B", "pf_2_desc": "視覺動畫與特效短片製作。",
            "pf_3_title": "互動 UI 專案 C", "pf_3_desc": "專注於使用者體驗的介面設計。",
            "pf_4_title": "遊戲模組開發", "pf_4_desc": "Minecraft 客製化素材與整合包。",
            "pf_5_title": "創意剪輯作品", "pf_5_desc": "結合節奏與特效的影音創作。",
            "pf_6_title": "敬請期待", "pf_6_desc": "更多精彩網頁與設計專案即將上線...",
        ...
        "zh-CN": {
            ...
            "page_title_portfolio": "作品集 | BroQiangStudio", "portfolio_header": "作品集", 
            "pf_btn": "查看专案详情 >",
            "pf_1_title": "网页开发专案 A", "pf_1_desc": "结合 HTML/CSS 的响应式个人网站设计。",
            "pf_2_title": "多媒体设计专案 B", "pf_2_desc": "视觉动画与特效短片制作。",
            "pf_3_title": "互动 UI 专案 C", "pf_3_desc": "专注于使用者体验的介面设计。",
            "pf_4_title": "游戏模组开发", "pf_4_desc": "Minecraft 客制化素材与整合包。",
            "pf_5_title": "创意剪辑作品", "pf_5_desc": "结合节奏与特效的影音创作。",
            "pf_6_title": "敬请期待", "pf_6_desc": "更多精彩网页与设计专案即将上线...",
        ...
        "en": {
            ...
            "pf_1_title": "Web Dev Project A", "pf_1_desc": "Responsive personal website using HTML/CSS.",
            "pf_2_title": "Multimedia Project B", "pf_2_desc": "Visual animations and short film production.",
            "pf_3_title": "Interactive UI Project C", "pf_3_desc": "User experience focused interface design.",
            "pf_4_title": "Game Modding", "pf_4_desc": "Minecraft customized resources and modpacks.",
            "pf_5_title": "Creative Editing", "pf_5_desc": "Audio-visual creation combining rhythm and effects.",
            "pf_6_title": "Coming Soon", "pf_6_desc": "More exciting projects are on the way...",
        ...
        "ms": {
            ...
            "pf_1_title": "Projek Web A", "pf_1_desc": "Laman web peribadi responsif menggunakan HTML/CSS.",
            "pf_2_title": "Projek Multimedia B", "pf_2_desc": "Animasi visual dan pengeluaran filem pendek.",
            "pf_3_title": "Projek UI Interaktif C", "pf_3_desc": "Reka bentuk antara muka fokus pengalaman pengguna.",
            "pf_4_title": "Modifikasi Permainan", "pf_4_desc": "Pek sumber dan modifikasi Minecraft yang disesuaikan.",
            "pf_5_title": "Suntingan Kreatif", "pf_5_desc": "Penciptaan audio-visual menggabungkan irama dan kesan.",
            "pf_6_title": "Akan Datang", "pf_6_desc": "Lebih banyak projek menarik akan tiba...",
